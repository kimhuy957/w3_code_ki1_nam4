                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://i.pinimg.com/736x/e0/3b/46/e03b46e5a704f8963c35811497aa39a9.jpg" alt="Admin" class="rounded-circle" width="150" />
                                <div class="mt-3">
                                    <h4><?php echo $_SESSION['user']; ?></h4>
                                    <p class="text-secondary mb-1">Full Stack Developer</p>
                                    <p class="text-muted font-size-sm">
                                        136 Xuan Thuy, Dich Vong Hau, Cau Giay, Ha Noi
                                    </p>
                    ...
                    <div class="card mt-3">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <a class="text-secondary" href="https://hnue.edu.vn/" target="_blank">https://hnue.edu.vn/</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <a class="text-secondary" href="https://github.com/kimhuy957/w3_code_ki1_nam4.git" target="_blank">Git.com</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <span class="text-secondary">X.com</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <a class="text-secondary" href="https://hnue.edu.vn/" target="_blank">Instagram.com</a>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0">
                                ...
                                <a class="text-secondary" href="https://hnue.edu.vn/" target="_blank">https://facebook.com/</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo $_SESSION['user']; ?></div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <a class="col-sm-9 text-secondary" href="p.hcdn@hnue.edu.vn"><?php echo $_SESSION['email']; ?></a>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">02437547823</div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-info" target="__blank" href="https://www.youtube.com/watch?v=fgpwTxIv76Q&list=RD0Vg3lWGZoq4&index=27&ab_channel=Nguy%C3%AAnH%C3%A0Official">Edit</a>
